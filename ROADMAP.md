...
- [x] Merge updated master into the branch, adapt Avo resources to name split and pretix fields (2026-09-08)
- [ ] Decide whether Avo stays the admin backend (Avo 4 moved search, authorization and scoping to paid add-ons; branch uses Avo 3, community tier)
