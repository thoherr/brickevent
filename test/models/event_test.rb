...
class EventTest < ActiveSupport::TestCase
  ...
  test "generate exhibits csv" do
    ...
    assert_equal "ID;Bestätigt;Vorname;Nachname;Email;MOC;Beschreibung;Anmerkungen;URL;Größe x;Größe y;Größe z;Größe Einheit;Größe x (cm);Größe y (cm);Größe z (cm);Tisch;Position;Versicherungswert;Versicherungswert Anlage;Baustunden;Anzahl Steine;Strom?;Sammeltransport;Gemeinschaftsprojekt?;Collab?;Teil Gemeinschaftsprojekt;Name Gemeinschaftsprojekt;Zuletzt geändert\n" +
                   ...
                   "45;true;User;One;user42@mytestdomain.de;Simple small MOC;Quite awesome;;;0;0;;m;;;;;;123;0.0;;;false;false;false;false;true;-;2024-09-10 00:00:00\n",
                 event3.exhibits_as_csv
    event42 = events(:fourty_two)
    assert_equal 4, event42.number_of_exhibits
    assert_equal "ID;Bestätigt;Vorname;Nachname;Email;MOC;Beschreibung;Anmerkungen;URL;Größe x;Größe y;Größe z;Größe Einheit;Größe x (cm);Größe y (cm);Größe z (cm);Tisch;Position;Versicherungswert;Versicherungswert Anlage;Baustunden;Anzahl Steine;Strom?;Sammeltransport;Gemeinschaftsprojekt?;Collab?;Teil Gemeinschaftsprojekt;Name Gemeinschaftsprojekt;Zuletzt geändert\n" +
                   "6;true;Second;user;second@mytestdomain.de;A Collab;;;;;;;cm;;;;;;0.0;;;;false;false;true;true;false;-;2024-10-11 00:00:00\n" +
                   "7;true;Second;user;second@mytestdomain.de;Part of Collab;;;;;;;cm;;;;;;;0.0;;;false;false;false;false;true;A Collab;2024-10-11 00:00:00\n" +
                   "44;false;Thomas;Herrmann;mail@thoherr.de;StarWars Installation;This is our SW Installation MOC;;https://moc3.example.com/;100;200;;m;10000.0;20000.0;;7;;0.0;1234;;;false;false;true;false;false;-;2021-05-04 00:00:00\n" +
                   "48;true;Thomas;Herrmann;mail@thoherr.de;Part of Installation MOC;Small but beautiful;;;0;0;;m;;;;;;456;0.0;;;false;false;false;false;true;StarWars Installation;2024-10-10 00:00:00\n",
