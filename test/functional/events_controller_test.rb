...
class EventsControllerTest < ActionController::TestCase
  ...
  test "should get exhibits as csv for event" do
    ...
    assert_response :success
    assert_equal "ID;Bestätigt;Name;Email;MOC;Beschreibung;Anmerkungen;URL;Größe x;Größe y;Größe z;Größe Einheit;Größe x (cm);Größe y (cm);Größe z (cm);Versicherungswert;Versicherungswert Anlage;Baustunden;Anzahl Steine;Strom?;Sammeltransport;Gemeinschaftsprojekt?;Teil Gemeinschaftsprojekt;Name Gemeinschaftsprojekt;Zuletzt geändert\n41;true;MyString;MyString;My first extraordinary MOC;Very awesome;Very important remark;MyString;1;2;;m;160.0;240.0;;1000;0.0;1;1;false;false;false;false;-;2018-06-15 00:00:00\n42;false;MyString;MyString2;Another great MOC;Even more awesome 'the - killer, bla bla bla...' MOC;Need my own exhibit hall;MyString;24;64;;m;2400.0;6400.0;;10000000;0.0;10000;1000000;false;true;false;false;-;2018-07-10 00:00:00\n",response.body.encode(Encoding::UTF_8)
  end
end
